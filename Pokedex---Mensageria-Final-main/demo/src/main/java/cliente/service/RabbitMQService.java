...
//import org.springframework.stereotype.Service; // Certifique-se de usar @Service
//import servidor.model.Treinador;
//
//@Service  // A classe RabbitMQService precisa ser anotada com @Service
...
//        rabbitTemplate.convertAndSend("treinador.novo", treinador);  // Envia para a fila de treinador
...
//        rabbitTemplate.convertAndSend("treinador.atualizar", treinador);
...
//        rabbitTemplate.convertAndSend("treinador.deletar", id);
